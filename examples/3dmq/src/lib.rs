...
async fn main() -> anyhow::Result<()> {
    let rust_logo = load_texture("D:/Job/creator/examples/3d_mac/assets/rust.png").await?;
    let ferris = load_texture("D:/Job/creator/examples/3d_mac/assets/ferris.png").await?;
