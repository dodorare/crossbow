...
mod tests {
    ...
    fn test_two() {
        let _get_libs_in_dir = dirs_to_write(
            &Path::new("C:\\Users\\den99\\Desktop\\Work\\DodoRare\\creator\\crates\\creator-tools\\res\\mipmap\\").to_owned(),
            // Path::new("manifest"),
        );
    }
